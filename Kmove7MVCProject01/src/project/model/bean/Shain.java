...
public class Shain {
	...
	public Shain(String shain_no, String shain_nm, String address, String busho_nm, String yakushoku_nm, int kihon_pay,
			String renraku_tel, String renraku_email, Date nyusha_ymd, Date taishoku_ymd, String ginko_nm,
			String koza_num, String zaishoku_st) {
		super();
